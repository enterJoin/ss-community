...
CREATE TABLE `image`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '自增ID',
  `name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '图片的生成名字',
...
CREATE TABLE `user`  (
  ...
  `head_photo_name` varchar(255) CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NULL DEFAULT NULL COMMENT '用户头像图片的生成名称，可为空',
  `register_time` timestamp(0) NOT NULL COMMENT '注册时间',
  `last_login_time` timestamp(0) NULL DEFAULT NULL COMMENT '最后登录时间',
  `last_update_info_time` timestamp(0) NULL DEFAULT NULL COMMENT '上一次修改用户资料时间',
